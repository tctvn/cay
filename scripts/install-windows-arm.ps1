...
# Len cau cai dat: irm https://raw.githubusercontent.com/tctvn/cay/main/scripts/install-windows-arm.ps1 | iex
...
$repo = "tctvn/cay"
$assetName = "cay-arm.exe"
$downloadUrl = "https://github.com/$repo/releases/latest/download/$assetName"
$installDir = "$env:LOCALAPPDATA\CayIME"
$exePath = "$installDir\cay-arm.exe"
