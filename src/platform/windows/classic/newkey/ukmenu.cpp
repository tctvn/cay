...
const wchar_t *VnMenuText[] = {
		L"Thông tin",
		L"Hướng dẫn",
		L"Bảng điều khiển...[CS+F5]",
		L"Công cụ...[CS+F6]",
		L"Chuyển mã nhanh - [CS+F9]",
		L"Gõ kiểu TELEX",
		L"Gõ kiểu VNI",
		L"Gõ kiểu VIQR",
		L"Gõ kiểu VIQR*",
...
void CUniKeyMenu::reload()
{
	if (m_pPref->m_vietGUI) {
		initMenu(m_hInst, m_hParentWnd, IDR_KEY_MENU, (wchar_t**)VnMenuText);
