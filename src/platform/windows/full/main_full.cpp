...
INT_PTR CALLBACK SettingsDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_INITDIALOG:
        ...
        SendDlgItemMessageW(hDlg, IDC_CHK_AUTO_RESTORE, BM_SETCHECK, g_config.autoRestore ? BST_CHECKED : BST_UNCHECKED, 0);
        return (INT_PTR)TRUE;
    ...
    case WM_COMMAND:
        ...
        else if (LOWORD(wParam) == IDC_CHK_AUTO_RESTORE) {
            g_config.autoRestore = (SendDlgItemMessageW(hDlg, IDC_CHK_AUTO_RESTORE, BM_GETCHECK, 0, 0) == BST_CHECKED);
            ConfigManager::SaveConfig(g_config);
            g_engine.autoRestoreEnabled = g_config.autoRestore;
        }
        else if (LOWORD(wParam) == IDOK || LOWORD(wParam) == IDCANCEL) {
            DestroyWindow(hDlg);
            g_hDlg = nullptr;
